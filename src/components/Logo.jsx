  ...
  return (
    <div className="flex items-center space-x-3">
      <div className="relative">
        ...
        <div
          className={`${sizeClasses[size]} bg-gradient-to-br from-indigo-600 via-purple-600 to-blue-600 rounded-xl flex items-center justify-center relative overflow-hidden shadow-lg`}
        >
          ...
          <div className="relative z-10 flex items-center justify-center">
            <span className="text-white font-bold text-xs opacity-40 absolute -left-1">
              {'<'}
            </span>
            <span className="text-white font-black text-sm">{initials}</span>
            <span className="text-white font-bold text-xs opacity-40 absolute -right-1">
              {'/>'}
            </span>
          </div>
