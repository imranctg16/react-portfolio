  ...
  const experience = [
    {
      ...
      duration: '2.5+ years',
      description:
        'Leading enterprise microservices platform development. Built reporting module processing millions of records daily, led monolith to microservices migration, and introduced centralized logging with PLG stack.',
      color: '#00A651',
      isActive: true,
    },
    {
      ...
      duration: '1.7 years',
      description:
        'Developed ERP modules for Bangladesh Academy of Rural Development including Accounting, HRM, Training systems within Laravel modular monolith architecture.',
      color: '#1976d2',
      isActive: false,
    },
    {
      ...
      duration: '1 year',
      description:
        'Enhanced enterprise applications for public and private sectors, optimized system performance with Redis caching, and researched Nuxt.js for production integration.',
      color: '#1976d2',
      isActive: false,
    },
    {
      ...
      duration: '1 year',
      description:
        'Built core application features, implemented responsive designs, and collaborated with clients for requirement analysis and technical solutions.',
      color: '#1976d2',
      isActive: false,
    },
  ];
  ...
  const education = [
    {
      ...
      period: '2014 - 2018',
      description:
        'CGPA: 3.69/4.00. Specialized in algorithms, data structures, and software engineering principles.',
    },
  ];
          ...
          <Box sx={{ mb: 6 }}>
            ...
            <Box>
              ...
              <Box sx={{ textAlign: 'center', mb: 8 }}>
                ...
                >
                  Technical Lead with almost 7 years of experience building
                  enterprise-grade web applications and leading development
                  teams.
                </Typography>
          ...
          >
            ...
            <Box
              sx={{
                ...
                inset: 0,
                background:
                  'linear-gradient(180deg, rgba(0,0,0,0.15) 0%, rgba(0,0,0,0.45) 70%)',
              }}
            />
            ...
            >
              <Typography
                variant="h6"
                sx={{ color: 'white', textShadow: '0 1px 2px rgba(0,0,0,0.6)' }}
              >
                          ...
                          <Box>
                            ...
                            >
                              <Typography
                                ...
                                onClick={() =>
                                  trackOutboundLink(job.companyUrl, job.company)
                                }
                                sx={{
                                  color: job.color,
                                  textDecoration: 'none',
