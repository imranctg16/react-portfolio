...
export const projects = [
  {
    ...
    description: 'An enterprise workflow automation system I\'ve been architecting for Grameenphone over the past 2 years. What started as a legacy CakePHP application has evolved into a robust microservices platform with 11 independent services, automating all workflows across the organization and winning multiple internal awards for efficiency improvements.',
    motivation: 'As a solution architect, I led the transformation of a monolithic CakePHP application into a modern microservices architecture. The challenge was to modernize legacy systems while maintaining business continuity for one of Bangladesh\'s largest telecom operators. This project has automated critical workflows and significantly improved operational efficiency.',
    image: dweDashboard,
    gif: dweGif,
    gallery: [
      { src: dweDashboard, alt: 'DWE Dashboard - Main Interface', caption: 'Comprehensive dashboard showing workflow statistics and key metrics' },
      { src: dweLogin, alt: 'DWE Login Interface', caption: 'Secure authentication system with enterprise-grade security' },
      { src: dweOtpEnforce, alt: 'OTP Enforcement', caption: 'Multi-factor authentication for enhanced security' },
      { src: dweWorkflow, alt: 'Workflow Management', caption: 'Dynamic workflow builder with configurable business logic' },
      { src: dweTicketsIndex, alt: 'Ticket Management System', caption: 'Issue tracking with SLA monitoring and performance metrics' },
      { src: dweReportPending, alt: 'Pending Reports View', caption: 'Real-time reporting system with advanced filtering' },
      { src: dweReportView, alt: 'Report Detail View', caption: 'Detailed report analysis with export capabilities' }
    ],
    technologies: ['Laravel 9+', 'Vue.js 3', 'MySQL 8.0', 'Redis', 'Docker', 'MinIO', 'RabbitMQ', 'Nginx', 'Laravel Sanctum'],
    liveUrl: '#', // Internal enterprise system
    githubUrl: 'https://github.com/imranctg16/DWE-Microservice', // Updated with actual repo
    ...
    status: 'Production',
    overview: 'Enterprise-grade microservices platform designed for digital workflow automation, featuring 11 independent services with dynamic form building, workflow state machines, regulatory compliance, and multi-tenant architecture.',
    problemStatement: 'Organizations needed flexible, compliant, and scalable digital workflow systems that could adapt to complex business processes while maintaining security standards and performance at enterprise scale.',
    solution: 'Built a comprehensive microservices architecture with API gateway pattern, custom authentication extensions, advanced performance optimization, and container-first deployment supporting complex organizational workflows.',
    keyFeatures: [
    ...
    architecture: {
      frontend: ['Vue.js 3', 'Composition API', 'Modern Build Tools', 'Responsive Design', 'Real-time WebSocket Updates'],
      backend: ['Laravel 9+', 'PHP 8+', 'Laravel Sanctum', 'RESTful APIs', 'Queue Processing'],
      microservices: ['API Gateway', 'User Service', 'Form Service', 'Ticket Service', 'Workflow Service', 'Report Service', 'Notification Service', 'MinIO Service', 'BTRC Service', 'ATS Service', 'RCMS'],
      database: ['MySQL 8.0', 'One Database Per Service', 'Performance Optimization', 'Custom Indexing'],
      infrastructure: ['Docker Compose', 'Nginx Reverse Proxy', 'Redis Cache', 'MinIO Object Storage', 'RabbitMQ Message Queue'],
      monitoring: ['Laravel Telescope', 'Custom Logging', 'Audit Trails', 'Health Check Endpoints']
    },
    metrics: {
      scale: '11 microservices with 10+ optimized database schemas',
      performance: '95% reduction in complex query execution time (20min → 30sec)',
      architecture: 'Multi-tenant support with complete data isolation',
      security: 'Enterprise-grade authentication with comprehensive audit logging',
      storage: 'Scalable object storage with S3-compatible MinIO API',
      communication: 'Standardized service communication with unified API response formats'
    },
    challenges: [
  ...
  },
  {
    ...
    description: 'Ever felt like SQL skills were getting rusty in the ORM era? I built this interactive learning platform to make SQL practice fun and engaging. It features progressive challenges, real-time feedback, streak tracking, and points system to keep you motivated while mastering database queries.',
    ...
    gif: sqlGif,
    gallery: [
      { src: sqlDashboard, alt: 'SQL Playground Dashboard', caption: 'Main dashboard showing progress tracking and challenge categories' },
      { src: sqlLogin, alt: 'Login Interface', caption: 'Clean authentication interface with progress tracking' },
      { src: sqlDbSchema, alt: 'Interactive Database Schema', caption: 'ReactFlow-based interactive database visualization with zoom/pan' },
      { src: sqlTableSchema, alt: 'Table Schema Details', caption: 'Detailed table structure with relationships and constraints' },
      { src: sqlProgress, alt: 'Progress Tracking', caption: 'Comprehensive progress tracking with streak system and points' },
      { src: sqlSuccess, alt: 'Success Celebration', caption: 'Celebration effects with particle animations for achievements' },
      { src: sqlHelp, alt: 'Help Documentation', caption: 'Built-in help system with SQL syntax reference' },
      { src: sqlAbout, alt: 'About Page', caption: 'Platform overview and learning methodology explanation' }
    ],
    ...
    status: 'Production',
    overview: 'Interactive SQL learning platform with gamification elements, real-time query evaluation, and comprehensive progress tracking designed for database education.',
    problemStatement: 'Traditional SQL learning methods lack engagement and fail to provide hands-on experience with real database scenarios, making it difficult for students to master complex query concepts.',
    solution: 'Built a comprehensive learning platform combining progressive challenges, real-time feedback, interactive database diagrams, and streak tracking to create an engaging educational experience.',
    keyFeatures: [
    ...
    architecture: {
      frontend: ['React 18', 'TypeScript', 'ReactFlow', 'Tailwind CSS', 'Custom Animations'],
      ...
      testing: ['PHPUnit', 'Jest', 'Integration Testing', '19 comprehensive tests']
    },
    metrics: {
  ...
  },
  {
    ...
    description: 'While preparing for my AWS Solutions Architect certification, I couldn\'t find a decent free platform for topic-wise practice. So I built one myself! This app contains 968+ carefully curated questions, topic-wise quizzes, mock exams, and note-taking features to make AWS exam prep more effective.',
    motivation: 'During my AWS Solutions Architect certification preparation, I realized there were hardly any free applications providing comprehensive practice exams on different AWS topics. I collected around 968 questions from various sources and built this platform where you can practice questions by individual topics, save notes, and take both topic-specific quizzes and full mock exams.',
    image: awsDashboard,
    gif: awsGif,
    gallery: [
      { src: awsDashboard, alt: 'AWS Exam Prep Dashboard', caption: 'Main dashboard with comprehensive question statistics and progress tracking' },
      { src: awsLogin, alt: 'Authentication System', caption: 'Secure login system with Laravel Sanctum integration' },
      { src: awsQuestion, alt: 'Practice Questions Interface', caption: 'Clean question interface with detailed explanations and references' },
      { src: awsTopicQuiz, alt: 'Topic-Based Quiz Mode', caption: 'Organized practice by AWS service categories and topics' },
      { src: awsTopicQuiz2, alt: 'Quiz Results Analytics', caption: 'Detailed performance analytics with strengths and improvement areas' },
      { src: awsNotes, alt: 'Personal Notes System', caption: 'Topic-based note-taking system for effective study organization' }
    ],
    ...
    teamSize: '1 developer',
    status: 'Development',
    overview: 'Enterprise-grade learning management system for AWS certification preparation with comprehensive question banks, progress tracking, and performance analytics.',
    problemStatement: 'Fragmented AWS study resources and lack of comprehensive progress tracking make certification preparation inefficient and difficult to measure.',
    solution: 'Developed a unified platform consolidating AWS exam materials with detailed analytics, performance metrics, and targeted learning paths.',
    keyFeatures: [
    ...
    architecture: {
      frontend: ['Vue.js 3.4', 'Vue Router 4.x', 'Pinia 2.x', 'Tailwind CSS', 'Vite 5.x'],
      backend: ['PHP 8.0+', 'Laravel 8.x', 'Laravel Sanctum', 'Eloquent ORM'],
      database: ['MongoDB 7.0', 'Flexible Document Storage', 'Custom Collections'],
  ...
  },
  {
    ...
    description: 'As someone who works with tons of documentation daily, I needed a solution to read multiple markdown files side by side without losing focus. This React app lets you open multiple docs in tabs, preview and edit live, supports Mermaid diagrams, and handles code snippets beautifully.',
    motivation: 'I do a lot of documentation work and often need to read multiple doc files side by side without losing focus. I couldn\'t find a decent solution that met my needs, so I created this React project where you can read multiple notes simultaneously, preview and edit live, with full support for Mermaid diagrams and code snippets.',
    image: readme1,
    gif: readmeGif,
    gallery: [
      { src: readme1, alt: 'README Reader Main Interface', caption: 'Clean markdown viewer with glassmorphism design and multi-tab support' },
      { src: readme2, alt: 'Mermaid Diagram Integration', caption: 'Interactive Mermaid diagrams with zoom, pan, and fullscreen capabilities' },
      { src: readme3, alt: 'Code Syntax Highlighting', caption: 'Beautiful syntax highlighting for 20+ programming languages with theme support' }
    ],
    ...
    teamSize: '1 developer',
    status: 'Production',
    overview: 'Feature-rich markdown viewer with interactive Mermaid diagrams, multi-tab support, and modern glassmorphism design optimized for developers.',
    problemStatement: 'Existing markdown viewers lack interactive features, proper diagram support, and modern user interfaces, making documentation review cumbersome.',
    solution: 'Built a comprehensive markdown viewer with advanced Mermaid diagram support, multi-tab functionality, and modern UI design.',
    keyFeatures: [
    ...
    architecture: {
      ...
      libraries: ['react-markdown 10.1.0', 'mermaid 11.9.0', 'react-syntax-highlighter', 'lucide-react'],
  ...
  },
  {
    ...
    description: 'My personal showcase built with React 18, featuring a modern glassmorphism design that balances aesthetics with functionality. This portfolio demonstrates my frontend skills while providing an engaging way to explore my projects, technical writing, and professional journey.',
    motivation: 'I wanted to create a professional online presence that not only showcases my technical skills but also reflects my design sensibilities and attention to detail. This portfolio serves as both a demonstration of my frontend capabilities and a platform to share my projects and technical insights.',
    image: portfolioImage,
    gallery: [
      { src: portfolioImage, alt: 'Portfolio Homepage', caption: 'Modern glassmorphism design with interactive animations and smooth transitions' }
    ],
    technologies: ['React 18', 'Material-UI', 'Framer Motion', 'Vite', 'Tailwind CSS', 'React Router'],
    ...
    teamSize: '1 developer',
    status: 'Production',
    overview: 'Modern portfolio website showcasing technical projects, skills, and blog posts with glassmorphism design and interactive user experience.',
    problemStatement: 'Need for a professional online presence that effectively showcases technical skills, projects, and provides engaging user experience across all devices.',
    solution: 'Built a comprehensive portfolio with modern design trends, interactive animations, integrated blog system, and optimized performance for professional presentation.',
    keyFeatures: [
    ...
    architecture: {
      ...
      styling: ['Material-UI v7', 'Tailwind CSS', 'Custom Glassmorphism', 'Responsive Design'],
